...
<body class="bg-gray-100 flex flex-col items-center justify-center h-screen">
    <div id="log-in-container" class="flex flex-col min-w-sm rounded-lg shadow-lg bg-white p-6">
        ...
        <form method="POST" id="login-form" action="login.php">
            ...
            <input type="number" name="employee-id" id="employee-id" placeholder="Employee ID" required class="w-full my-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"><br>
            <label for="password">Password</label><br>
            <input type="password" name="password" id="password" placeholder="Password" required class="w-full my-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500"><br>
            <button type="submit" id="login-button" class="w-full cursor-pointer font-medium mt-2 px-6 py-2 bg-amber-500 text-white rounded-md hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50">Login</button><br>
